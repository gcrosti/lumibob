...
Use when asked to audit AWS spend, explain a bill, investigate a cost overage, or check for wasted cloud resources — e.g. "why is the AWS bill higher than expected", "audit our cloud costs", "run a cost audit".
