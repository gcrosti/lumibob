...
Use when designing, launching, or reviewing any Optuna tuning study for LumiBob —
scoring-quality studies, backtest studies, cache/analytical studies. This skill is the
**anti-overfitting methodology and source of truth for the overfitting gates**. It exists
because Pass A v4 reported a great in-sample objective (+52) that was pure overfitting,
and every guard below is a symptom of that failure made impossible to miss.
